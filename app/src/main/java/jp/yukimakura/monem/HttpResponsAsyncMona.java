...
public class HttpResponsAsyncMona extends AsyncTask<Void, Void, Double> {

    private MainActivity mainActivity;
    private Double pricedata = 0.0;

    // コンストラクター
    public HttpResponsAsyncMona(MainActivity activity){
    ...
    protected Double doInBackground(Void... params) {
        ...
        URL url = null;
        String urlSt = "https://api.zaif.jp/api/1/last_price/mona_jpy";
        ...
        String readSt = "";
            ...
            try {
                ...
                Log.e("HTTP REQ MONA", Double.toString(pricedata));
    ...
    protected void onProgressUpdate(Void... values) {
        ...
        mainActivity.prjson.printJsondataMona(pricedata);
    ...
    protected void onPostExecute(Double result) {
        ...
        mainActivity.prjson.printJsondataMona(result);
        // doInBackground後処理
    }
